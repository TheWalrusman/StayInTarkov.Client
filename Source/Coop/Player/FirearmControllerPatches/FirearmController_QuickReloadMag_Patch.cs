...
namespace SIT.Core.Coop.Player.FirearmControllerPatches
{
    public class FirearmController_QuickReloadMag_Patch : ModuleReplicationPatch
    {
        ...
        {
            return GetLogger(typeof(FirearmController_QuickReloadMag_Patch));
        }
        ...
        {
            GetLogger(typeof(FirearmController_QuickReloadMag_Patch)).LogDebug("Replicated");
            ...
            if (player.HandsController is EFT.Player.FirearmController firearmCont)
            {
                try
                {
                    firearmCont.FirearmsAnimator.ReloadFast(true);
                }
                catch (Exception e)
                {
